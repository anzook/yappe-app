    ...
    return (
      <Container>
        <Card className='dog-card' onClick={this.props.onClick} style={{ width: '21rem' }}>
          <Card.Body>
           {this.props.pictureLink ? <img alt='Pet photo' src={this.props.pictureLink} className='dog-card-image' />  : <img alt='Pet photo' src="/images/placeholder-dog.jpg" className='dog-card-image' /> }
